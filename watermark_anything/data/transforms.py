...
# image_mean_half = torch.tensor([0.5,0.5,0.5])
# image_std_half = torch.tensor([0.5,0.5,0.5])
...
# normalize_img_half = transforms.Normalize(image_mean_half, image_std_half)
# unnormalize_img_half = transforms.Normalize(-image_mean_half / image_std_half, 1 / image_std_half)
...
# val_transform_half = transforms.Compose([
#         transforms.Resize(256),
#         transforms.CenterCrop(256),
#         transforms.ToTensor(),
#         normalize_img_half,
...
def get_transforms_segmentation_half(
    img_size: int,
    brightness: float = 0.2,
    contrast: float = 0.2,
    saturation: float = 0.2,
